...
int main(int argc, char** argv)
{
    ...
    MPI_File_open(world_comm, "A.txt", MPI_MODE_RDWR | MPI_MODE_CREATE | MPI_MODE_DELETE_ON_CLOSE, MPI_INFO_NULL, &fileA);
    MPI_File_open(world_comm, "B.txt", MPI_MODE_RDWR | MPI_MODE_CREATE | MPI_MODE_DELETE_ON_CLOSE, MPI_INFO_NULL, &fileB);
    MPI_File_open(split_comm, "A.txt", MPI_MODE_RDWR | MPI_MODE_CREATE | MPI_MODE_DELETE_ON_CLOSE, MPI_INFO_NULL, &fileC);
    MPI_File_open(split_comm, "B.txt", MPI_MODE_RDWR | MPI_MODE_CREATE | MPI_MODE_DELETE_ON_CLOSE, MPI_INFO_NULL, &fileD);
